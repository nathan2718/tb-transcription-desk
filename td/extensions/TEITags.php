...
$wgExtensionFunctions[] = "wfTEITagsSpecialpage";
...
function wfRenderHI( $input, $args, $parser, $frame ) {
  $render = $args['rend'];
  $output = $parser->recursiveTagParse( $input, $frame );
...
function wfRenderHEAD( $input, $args, $parser, $frame ) {
  $output = $parser->recursiveTagParse( $input, $frame );
...
function wfRenderFOREIGN( $input, $args, $parser, $frame ) {
  $output = $parser->recursiveTagParse( $input, $frame );
...
function wfRenderSIC( $input, $args, $parser, $frame ) {
  $output = $parser->recursiveTagParse( $input, $frame );
